...
const PlacementTechnicalCombined = () => {
  const [file, setFile] = useState(null);
  const navigate = useNavigate();

  // Placement Procedure Data
  const steps = [
    {
      title: "Registration",
      description: "Students must register with the placement cell by submitting their details and updated resume."
    },
    {
      title: "Eligibility Check",
      description: "Academic records and other criteria are verified to ensure eligibility for placement drives."
    },
    {
      title: "Company Registration",
      description: "Students can register for specific companies based on their interests and eligibility."
    },
    {
      title: "Pre-Placement Talk",
      description: "Companies conduct presentations about their organization, roles, and selection process."
    },
    {
      title: "Written Test/Online Assessment",
      description: "Technical and aptitude tests are conducted to shortlist candidates."
    },
    {
      title: "Technical Interview",
      description: "Shortlisted candidates undergo technical interviews to assess domain knowledge."
    },
    {
      title: "HR Interview",
      description: "Final round to assess personality, communication skills, and cultural fit."
    }
  ];

  const skills = [
    { title: "Technical Skills", description: "Improve coding, software development, and core technical concepts." },
    { title: "Quants & Reasoning", description: "Enhance problem-solving, logical reasoning, and aptitude skills." },
    { title: "Soft Skills", description: "Develop communication, teamwork, and leadership skills." }
  ];
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gray-50">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 animate-gradient" />
      </div>
        ...
        <div className="space-y-8 mb-16">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300"
            >
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-10 h-10 bg-blue-600 text-white rounded-xl flex items-center justify-center">
                  {index + 1}
                </div>
                <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {skills.map((skill, index) => (
            <motion.div
              ...
              className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-lg hover:shadow-xl cursor-pointer"
              onClick={() => navigate('/technical-problems')}
            >
...
export default PlacementTechnicalCombined;